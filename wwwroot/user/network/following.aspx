<%@ Page Language="C#" AutoEventWireup="true" CodeFile="following.aspx.cs" Inherits="user_network_network" %>
...
<div class="container">
             ...
             <div class="col-md-6">
                 <div class="network-panel">
                    ...
                    <div class="netowrk-main-body">
                     ...
                     <div id="loadingfollowing" class="load-network-data-flex"></div>
                        <!-- ehent here is no foloowinng -->   
                        <div class="nonetwork nofollowing" >
                              <span class="fa fa-user-o" style="font-size:40px"></span>
                                <br />
                                 <h4>
                                       You are following no one at thios moment
                                </h4>
                                  <h6>
                                      Start following people that matters to you and to get updates from them in your feed.
                                 </h6>
                          </div>
                    </div>
                </div>
        ...
        <script src="../../userpagescripts/following.js"></script>
